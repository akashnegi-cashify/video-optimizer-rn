...
void main() {
  ...
  group('PickupReceiveBarcodeScannerWidget', () {
    ...
    testWidgets('displays Submit button', (tester) async {
      ...
      expect(find.byType(CshBigButton), findsAtLeastNWidgets(1));
    });
    ...
    testWidgets('submit button calls onPartReceive with text input',
      ...
      // Tap submit button (last CshBigButton in tree, BarCodeScannerWidget may contain another)
      final submitButton = find.byType(CshBigButton).last;
