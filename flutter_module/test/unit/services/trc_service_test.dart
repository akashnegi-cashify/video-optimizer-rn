  ...
  group('TrcService', () {
    ...
    group('constructor', () {
      ...
      test('should create instance with addAuthorization as true', () {
        // Arrange & Act
        final service = TrcService(addAuthorization: true);
      ...
      test('should create instance with addAuthorization as false when specified', () {
        // Arrange & Act
        final service = TrcService(addAuthorization: false);
    ...
    group('getServiceGroup', () {
      test('should return TRCServiceGroups.unifyTrc', () {
        // Act
        final result = sut.getServiceGroup();

        // Assert
        expect(result, TRCServiceGroups.unifyTrc);
      });

      test('should return unifyTrc regardless of addAuthorization value', () {
        // Arrange
        final serviceWithAuth = TrcService(addAuthorization: true);
        final serviceWithoutAuth = TrcService(addAuthorization: false);

        // Act & Assert
        expect(serviceWithAuth.getServiceGroup(), TRCServiceGroups.unifyTrc);
        expect(serviceWithoutAuth.getServiceGroup(), TRCServiceGroups.unifyTrc);
      });

      test('service group value should be "unify-trc"', () {
        // Act
        final result = sut.getServiceGroup();

        // Assert
        expect(result.value, 'unify-trc');
      });
    });
    ...
    group('multiple instances', () {
      test('should have independent authorization settings', () {
        // Arrange
        final service1 = TrcService(addAuthorization: true);
        final service2 = TrcService(addAuthorization: false);
      ...
      test('different instances should return same service group', () {
        // Arrange
        final service1 = TrcService();
        final service2 = TrcService(addAuthorization: true);
        final service3 = TrcService(addAuthorization: false);
