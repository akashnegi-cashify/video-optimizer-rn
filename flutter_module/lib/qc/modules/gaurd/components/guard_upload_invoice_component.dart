...
@CshComponent(
  ...
  componentGroup: QcComponentGroup.qcGuardUploadInvoiceComponentKey,
  params: UploadInvoiceCompParamKeys.values,
  paramModel: UploadInvoiceCompParam,
)
  ...
  Widget buildView(BuildContext context, configModel) {
    return paramBuilder((model) {
      return ChangeNotifierProvider(
          create: (_) => UploadInvoiceProvider(model.deviceCount, model.selectedAgent),
          child: const GuardUploadInvoiceWidget());
    });
  }
