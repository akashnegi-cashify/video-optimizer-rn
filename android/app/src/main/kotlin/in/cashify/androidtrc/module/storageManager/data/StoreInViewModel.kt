 ...
 */
class StoreInViewModel @Inject constructor() : BaseViewModel()
{
    var isDeviceBarcode: Boolean = false
    ...
    var fetchStorageDetailResponse: FetchStorageDetailsResponse? = null

    var barcodeHeading : String? = null
    ...
    fun saveStoreinDevice(
        ...
        service.execute(object :
            ...
            override fun getAPIAsync(api: StorageMangerAPi): Deferred<retrofit2.Response<FetchStorageDetailsResponse>> {
                return api.saveStoreinDevice(trayBarcode,deviceBarcode)
            }
