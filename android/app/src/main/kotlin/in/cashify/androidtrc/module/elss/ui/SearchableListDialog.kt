...
class SearchableListDialog : DialogFragment(),
    SearchView.OnQueryTextListener, SearchView.OnCloseListener {
    private var listAdapter: ArrayAdapter<*>? = null
    private var _listViewItems: ListView? = null
    private var _searchableItem: SearchableItem<Any>? = null
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        if (null != savedInstanceState) {
            _searchableItem = savedInstanceState.getSerializable("item") as SearchableItem<Any>?
        }
        // Change End
        val rootView: View = inflater.inflate(`in`.cashify.androidtrc.R.layout.searchable_list_dialog, null)
        setData(rootView)
        val alertDialog =
    ...
    fun setOnSearchableItemClickListener(searchableItem: SearchableItem<Any>?) {
    ...
    private fun setData(rootView: View) {
        ...
        _searchView =
            rootView.findViewById<View>(`in`.cashify.androidtrc.R.id.search) as SearchView
        ...
        val items =
            arguments.getSerializable(ITEMS) as List<*>?
        _listViewItems =
            rootView.findViewById<View>(`in`.cashify.androidtrc.R.id.listItems) as ListView
