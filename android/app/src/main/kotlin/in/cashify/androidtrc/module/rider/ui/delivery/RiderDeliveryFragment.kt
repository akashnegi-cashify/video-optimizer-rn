 ...
 * Use the [RiderDeliveryFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RiderDeliveryFragment : BaseFragment() {
    private var activityViewModel: RiderActivityViewModel? = null
    private var binding: FragmentRiderDeliveryBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_rider_delivery, container, false)

        binding?.viewPager?.setAdapter(RiderDeliveryReceiveViewpagerAdapter(childFragmentManager, lifecycle))
    ...
    companion object {
         ...
         * @return A new instance of fragment RiderDeliveryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RiderDeliveryFragment().apply {
