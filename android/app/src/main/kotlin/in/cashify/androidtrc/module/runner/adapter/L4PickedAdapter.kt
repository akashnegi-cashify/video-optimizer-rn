 ...
 */
class L4PickedAdapter : RecyclerView.Adapter<L4PickedAdapter.L4PickedHolder>(),
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): L4PickedHolder {
        return L4PickedHolder(
    ...
    override fun onBindViewHolder(holder: L4PickedHolder, position: Int) {
        val allocatedToEng = pickedList[position]
        holder.onBind(allocatedToEng)

    }

    class L4PickedHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
