...
ScanDeviceResponse _$ScanDeviceResponseFromJson(Map<String, dynamic> json) => ScanDeviceResponse(
      json['__ca'] == null ? null : CashifyAlert.fromJson(json['__ca'] as Map<String, dynamic>),
      json['turl'] as String?,
    )..scanDeviceData = json['dt'] == null ? null : ScanDeviceData.fromJson(json['dt'] as Map<String, dynamic>);

Map<String, dynamic> _$ScanDeviceResponseToJson(ScanDeviceResponse instance) => <String, dynamic>{
      '__ca': instance.cashifyAlert,
      'turl': instance.trackUrl,
      'dt': instance.scanDeviceData,
    };

ScanDeviceData _$ScanDeviceDataFromJson(Map<String, dynamic> json) => ScanDeviceData()
...
Map<String, dynamic> _$ScanDeviceDataToJson(ScanDeviceData instance) => <String, dynamic>{
