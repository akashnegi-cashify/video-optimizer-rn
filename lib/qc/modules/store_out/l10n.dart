...
class L10n extends BaseL10n {
  ...
  String get pleaseScanDeviceBarcode => Intl.message('Please Scan Device Barcode', locale: localName, name: 'pleaseScanDeviceBarcode');
  String get pleaseScanLocationBarcode => Intl.message('Please Scan Location Barcode', locale: localName, name: 'pleaseScanLocationBarcode');
  ...
  String get barcodeMismatchNTryAgain => Intl.message('Barcode Mismatch\nTry again!', locale: localName, name: 'barcodeMismatchNTryAgain');
