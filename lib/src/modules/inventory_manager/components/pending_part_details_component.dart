...
part 'pending_part_details_component.g.dart';
...
class PendingPartDetailsComponents extends StatelessComponent<NoneConfigModel> {
  ...
  Widget buildView(BuildContext context, configModel) {
    return paramBuilder((param) {
      return _PendingPartDetailsWidget(
...
class _PendingPartDetailsWidget extends StatelessWidget {
  final PendingPartDetailsScreenArguments? args;

  const _PendingPartDetailsWidget({
    Key? key,
    this.args,
  }) : super(key: key);
