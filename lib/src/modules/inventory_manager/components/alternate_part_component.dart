...
import '../models/alternate_part_comp_config.dart';
...
@CshComponent(
    ...
    configModel: AlternatePartConfig,
...
class AlternatePartComponent extends StatelessComponent<AlternatePartConfig> {
  ...
  Function(Map<String, dynamic> data)? fromConfig() {
    return AlternatePartConfig.fromConfig;
  }
}
