...
RubbingDeviceData _$RubbingDeviceDataFromJson(Map<String, dynamic> json) => RubbingDeviceData()
  ..deviceId = json['did'] as int
  ..productTitle = json['pt'] as String?
  ..deviceBarcode = json['dbr'] as String?
  ..trayBarcode = json['tbr'] as String?;

Map<String, dynamic> _$RubbingDeviceDataToJson(RubbingDeviceData instance) => <String, dynamic>{
