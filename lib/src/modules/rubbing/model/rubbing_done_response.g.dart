...
RubbingDoneResponse _$RubbingDoneResponseFromJson(Map<String, dynamic> json) => RubbingDoneResponse(
...
Map<String, dynamic> _$RubbingDoneResponseToJson(RubbingDoneResponse instance) => <String, dynamic>{
