...
EngineerPartInfo _$EngineerPartInfoFromJson(Map<String, dynamic> json) => EngineerPartInfo()
...
Map<String, dynamic> _$EngineerPartInfoToJson(EngineerPartInfo instance) => <String, dynamic>{
      'sku': instance.sku,
