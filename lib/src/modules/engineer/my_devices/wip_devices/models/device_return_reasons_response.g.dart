...
DeviceReturnReasonsResponse _$DeviceReturnReasonsResponseFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$DeviceReturnReasonsResponseToJson(DeviceReturnReasonsResponse instance) => <String, dynamic>{
