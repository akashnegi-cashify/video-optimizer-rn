...
SendToTlResponse _$SendToTlResponseFromJson(Map<String, dynamic> json) => SendToTlResponse(
...
Map<String, dynamic> _$SendToTlResponseToJson(SendToTlResponse instance) => <String, dynamic>{
