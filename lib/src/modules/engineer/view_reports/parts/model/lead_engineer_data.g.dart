...
LeadEngineerData _$LeadEngineerDataFromJson(Map<String, dynamic> json) =>
    LeadEngineerData()
      ..leadEngineerPartCost = json['lpc'] == null
          ? null
          : LeadEngineerPartCost.fromJson(json['lpc'] as Map<String, dynamic>)
      ..leadEngineerPartConsumption = json['lpcon'] == null
          ? null
          : LeadEngineerPartConsumption.fromJson(
              json['lpcon'] as Map<String, dynamic>);
