...
LeadEngineerPartReportResponse _$LeadEngineerPartReportResponseFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$LeadEngineerPartReportResponseToJson(LeadEngineerPartReportResponse instance) =>
    <String, dynamic>{
