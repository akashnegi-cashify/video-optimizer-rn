...
LeadEngineerData _$LeadEngineerDataFromJson(Map<String, dynamic> json) => LeadEngineerData()
  ..leadEngineerEfficiency =
      json['leff'] == null ? null : LeadEngineerEfficiency.fromJson(json['leff'] as Map<String, dynamic>)
  ..leadEngineerAvgRepairTime =
      json['lrt'] == null ? null : LeadEngineerAvgRepairTime.fromJson(json['lrt'] as Map<String, dynamic>)
  ..leadEngineerVolume = json['lv'] == null ? null : LeadEngineerVolume.fromJson(json['lv'] as Map<String, dynamic>);
