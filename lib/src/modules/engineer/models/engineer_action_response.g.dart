...
EngineerActionResponse _$EngineerActionResponseFromJson(Map<String, dynamic> json) => EngineerActionResponse(
...
Map<String, dynamic> _$EngineerActionResponseToJson(EngineerActionResponse instance) => <String, dynamic>{
