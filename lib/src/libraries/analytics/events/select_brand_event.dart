...
class SelectBrandEvent extends CommonEvents {
  final String barcode;
  final String? brandId;

  SelectBrandEvent(this.barcode, this.brandId);

  @override
  String getSubordinateKey() {
    return AnalyticEventKeys.manualTesting.selectBrand;
  }
  ...
  Future<Map<String, dynamic>?> getArguments() async {
    ...
    arg?[AnalyticEventParams.brandId] = brandId;
    return arg;
  }
}
