...
class AppRemoteConfig {
  ...
  static const Map<String, dynamic> DEFAULT_CONFIG = {
    ...
    KEY_APP_SUPPORTED_VERSIONS:
        '{"dt":[{"version":"4.0.0","isMajor":false,"apkUrl":"https://s3.ap-south-1.amazonaws.com/app.cashify.in/flutter-builds/flutter_trc/prod/prod/prod/148/Release/app-prod-release.apk"},{"version":"4.0.1","isMajor":false,"apkUrl":"https://s3.ap-south-1.amazonaws.com/app.cashify.in/flutter-builds/flutter_trc/prod/prod/prod/149/Release/app-prod-release.apk"},{"version":"4.0.2","isMajor":true,"apkUrl":"https://s3.ap-south-1.amazonaws.com/app.cashify.in/flutter-builds/flutter_trc/prod/prod/prod/152/Release/app-prod-release.apk"}]}',
  };
}
